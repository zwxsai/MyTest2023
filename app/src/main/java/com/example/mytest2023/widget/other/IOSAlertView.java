...
public class IOSAlertView {
    ...
    private ViewGroup rootView;//IOSAlertView 的 根View
    ...
    public IOSAlertView(Builder builder) {
    ...
    public IOSAlertView(String title, String msg, String cancel, String[] destructive, String[]
            others, Context context, Style style, OnItemClickListener
                                onItemClickListener) {
...
//                initIOSAlertViews(layoutInflater);
        ...
        alertButtonListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                if (onItemClickListener != null)
                    onItemClickListener.onItemClick(IOSAlertView.this, position);
                dismiss();
            }
        });
    }
    ...
    protected void initIOSAlertViews(LayoutInflater layoutInflater) {
        Context context = contextWeak.get();
        if (context == null) return;
        ...
        if (mDatas.size() <= HORIZONTAL_BUTTONS_MAXCOUNT) {
            ...
            for (int i = 0; i < mDatas.size(); i++) {
                ...
                position++;
                loAlertButtons.addView(itemView, new LinearLayout.LayoutParams(LinearLayout
    ...
    public IOSAlertView addExtView(View extView) {
    ...
    public View getExtView() {
        return loAlertHeader.getChildAt(loAlertHeader.getChildCount() - 1);
    }
    ...
    public IOSAlertView setOnDismissListener(OnDismissListener onDismissListener) {
    ...
    public static class Builder {
        ...
        public IOSAlertView build() {
            return new IOSAlertView(this);
        }
    }

...
public class MigrationHelper {
    ...
    private static final String CONVERSION_CLASS_NOT_FOUND_EXCEPTION = "MIGRATION HELPER - CLASS " +
            "DOESN'T MATCH WITH THE CURRENT PARAMETERS";
    ...
    @SafeVarargs
    private final void generateTempTables(Database db, Class<? extends AbstractDao<?, ?>>...
            daoClasses) {
...
//                        Crashlytics.logException(exception);
    ...
    private String getTypeByClass(Class<?> type) throws Exception {
        ...
        //        Crashlytics.logException(exception);
        throw new Exception(CONVERSION_CLASS_NOT_FOUND_EXCEPTION.concat(" - Class: ").concat(type
                .toString()));
    }

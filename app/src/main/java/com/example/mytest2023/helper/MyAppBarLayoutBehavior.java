...
public class MyAppBarLayoutBehavior extends AppBarLayout.Behavior {
    ...
    public boolean onInterceptTouchEvent(CoordinatorLayout parent, AppBarLayout child, MotionEvent ev) {
        Log.e(TAG, "onInterceptTouchEvent: " + child.getTotalScrollRange());
    ...
    @Override
    public void onNestedPreScroll(CoordinatorLayout coordinatorLayout, AppBarLayout child, View target, int dx,
                                  int dy, int[] consumed, int type) {
        Log.e(TAG,
                "onNestedPreScroll: " + child.getTotalScrollRange() + " ,dx:" + dx + " ,dy:" + dy + " ,type:" + type);
    ...
    public void onNestedScroll(CoordinatorLayout coordinatorLayout, AppBarLayout child, View target, int dxConsumed,
        ...
        Log.e(TAG, "onNestedScroll: target:" + target.getClass() + " ," + child.getTotalScrollRange() + " ," +
                "dxConsumed:"

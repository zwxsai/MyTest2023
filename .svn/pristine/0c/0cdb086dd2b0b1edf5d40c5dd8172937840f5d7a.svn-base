...
/**
 * Created by 钟文祥 on 2020/5/14.
 * Describer:
 */
public class BasePagerAdapter extends FragmentPagerAdapter {

    private FragmentManager mFragmentManager;
    private List<String> mTitles;//专给TabLayout使用
    ...
    public BasePagerAdapter(FragmentManager fm, List<String> titles, List<Fragment>
            fragments) {
        super(fm);
        this.mTitles = titles;
        mFragmentManager = fm;
    ...
    private void setFragmentPositionMapForUpdate() {
        ...
        for (int i = 0; i < mFragmentList.size(); i++) {
            mFragmentPositionMapAfterUpdate.put(Long.valueOf(getItemId(i)).intValue(), String
                    .valueOf(i));
        }
    }
